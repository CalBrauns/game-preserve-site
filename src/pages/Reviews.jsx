...
const REVIEWS = [
  ...
  { id: 7, name: 'James O.',      avatar: '👴', stars: 5, date: 'April 2025',    text: "My son brought me here to look around. Four hours later I finally put down the Pac-Man joystick. Haven't had that much fun in decades. Now I'm the one dragging him back.", tag: 'CLASSIC',     color: '#1a5fff' },
